...
class Pinterest:
    ...
    def GetID(self, url):
        ...
        self.UrlJS = re.search(r'"https://s.pinimg.com/webapp/app-www-closeup-duplo-UnauthCloseupRelatedPins.id_ID-(.*?)"', str(response)).group(1)
    ...
    def GetHASH(self):
        ...
        response = self.ses.get('https://s.pinimg.com/webapp/app-www-closeup-duplo-UnauthCloseupRelatedPins.id_ID-{}'.format(self.UrlJS), headers=headers).text
    ...
    def Dumps(self, queryhash, nextpage):
        ...
        json_data = {
            ...
            'variables': {
                ...
                'contextPinIds': None,
                'isDesktop': True,
                'showMultiColumnBoardRecommendationModule': True,
                'showMultiColumnRelatedIdeasModule': False
            }
        }
        response = self.ses.post('https://id.pinterest.com/_/graphql/', cookies={'cookie': self.csrftoken}, headers=headers, json=json_data).text
